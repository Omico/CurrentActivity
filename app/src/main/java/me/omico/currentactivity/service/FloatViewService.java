...
public final class FloatViewService extends ForegroundService {
    ...
    */
    ...
    private void initFloatView() {
        ...
        */
        ...
        mFloatWindow.setOnFloatWindowClickListener(v -> loadGestureAction(GESTURE_CLICK));

        mFloatWindow.setOnFloatWindowLongClickListener(v -> {
    ...
    private void initFloatViewContent() {
        ...
        handler.postDelayed(() -> tipTextView.setVisibility(View.GONE), 5000);
    }
