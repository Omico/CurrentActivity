...
val LocalMonitorServiceController = staticCompositionLocalOf<MonitorServiceController> {
    error("LocalMonitorServiceController value not available.")
}

@Composable
fun rememberMonitorServiceStatus(): State<MonitorServiceStatus> =
    LocalMonitorServiceController.current.status.collectAsState()
