...
sealed interface HomeAction {
    object RequestShizukuPermission : HomeAction
    object NavigateToShizukuManager : HomeAction
    object NavigateToOverlayPermissionManager : HomeAction
    data class MonitorSwitchStatusChanged(
        val checked: Boolean,
    ) : HomeAction
}

typealias OnSubmitHomeAction = (HomeAction) -> Unit
