 ...
 */
package me.omico.currentactivity.monitor

sealed interface MonitorServiceStatus {
    object Starting : MonitorServiceStatus
    object Started : MonitorServiceStatus
    object Stopping : MonitorServiceStatus
    object Stopped : MonitorServiceStatus
}

val MonitorServiceStatus.isBusy: Boolean
    get() = when (this) {
        MonitorServiceStatus.Starting,
        MonitorServiceStatus.Stopping,
        -> true
        MonitorServiceStatus.Started,
